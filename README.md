...
Este repositorio contiene la solución al **Examen 1 (10%)** de la asignatura **Programación Web** en la *Institución Universitaria Marco Fidel Suarez*, impartida por el docente Walter Gómez. 
...
* Boleta Familiar: $8.000.
* Boleta Adulto Mayor: $4.500.
* Boleta Normal: $12.500.

Además, la API calcula automáticamente recargos si el servicio de la atracción se presta en horario nocturno:
* Incremento del 15% para la boleta tipo Familiar en servicio nocturno.
...
* **Registrar Venta:** Permite ingresar una nueva venta indicando la atracción, tipo de boleta, si es jornada nocturna y la cantidad comprada. El sistema calcula automáticamente el valor total a pagar.
* **Consultar Ventas:** Endpoint para listar todas las ventas realizadas hasta el momento.
...
* **Persistencia:** Almacenamiento temporal en memoria mediante colecciones de objetos, tal como lo requiere el prototipo inicial.
* **Pruebas:** Todas las operaciones y validaciones de la API están diseñadas para ser probadas mediante Postman.
